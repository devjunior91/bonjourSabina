...
:root{
  ...
  --brand-dark:#3a3028;
  --accent:#9B0006;
  --accent-pale:rgba(155,0,6,.08);
}
body,#root{background:#F5F0EA;min-height:100vh;font-family:'DM Sans',sans-serif;color:var(--ink);}
.sidebar{position:fixed;left:0;top:0;bottom:0;width:var(--sidebar-w);background:#ffffff;border-right:1px solid rgba(26,20,16,.08);display:flex;flex-direction:column;z-index:200;overflow:hidden;-webkit-transform:translateZ(0);}
.sb-brand{padding:32px 4px 32px;margin-bottom:0;flex-shrink:0;}
...
.sb-section{font-size:9px;letter-spacing:.14em;text-transform:uppercase;color:rgba(26,20,16,.35);padding:12px 20px 5px;font-family:'DM Sans',sans-serif;font-weight:500;flex-shrink:0;}
.sb-nav{display:flex;flex-direction:column;gap:1px;padding:0 10px;flex:1;overflow-y:auto;background:#ffffff;}
...
.ni:hover{background:var(--accent-pale);color:var(--accent);}
.ni:hover svg{color:var(--accent);}
...
button[style*="var(--brand)"]:hover{background:var(--accent)!important;transition:background .18s;}
/* "View all" / italic text link buttons */
button[style*="var(--gold-deep)"]:hover{color:var(--accent)!important;}
/* Small icon/action buttons */
.sb2:hover{background:var(--accent-pale);color:var(--accent);}
.bc2:hover{background:var(--accent-pale);border-color:var(--accent);color:var(--accent);}
...
.pomo-preset:hover{background:var(--accent-pale);color:var(--accent);border-color:var(--accent);}
.pomo-preset.on{background:var(--brand);color:#f4ede3;border-color:var(--brand);}
...
.pomo-btn.start:hover{background:var(--accent);}
.pomo-btn.pause{background:var(--parchment);color:var(--ink);border:1px solid var(--border);}
.pomo-btn.pause:hover{background:var(--accent-pale);color:var(--accent);}
...
.bp:hover{background:var(--accent);}
...
.pb:hover{background:var(--accent-pale);color:var(--accent);border-color:var(--accent);}
.pb.on{background:var(--brand);color:#f4ede3;border-color:var(--brand);}
...
.cab:hover{background:var(--accent);}
...
.bil-tab:hover{background:var(--accent-pale);color:var(--accent);border-color:var(--accent);}
...
export default function App() {
  ...
  const openTaskEdit=(t)=>{setEditTaskId(t.id);setEditTaskText(t.text);setEditTaskPri(t.priority||"medium");setEditTaskDue(t.dueDate||TODAY);setTaskMenuId(null);};
  ...
  if(!unlocked) return (
    <>
      ...
      <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#F5F0EA",padding:24}}>
        {/* Logo */}
        <img src={ptLogo} alt="The Productivity Theory" style={{width:440,marginBottom:40,display:"block"}}/>
    ...
    <>
      ...
      <aside className="sidebar">
        <div className="sb-brand">
          <img src={ptLogo} alt="The PT" style={{width:"108%",marginLeft:"-4%",display:"block"}}/>
        </div>
...
<div style={{padding:"0 24px",maxWidth:1280,boxSizing:"border-box"}}>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"center",gap:10,paddingTop:2}}>
          {[
            ...
            <div key={row.label} style={{display:"flex",alignItems:"center",gap:10}}>
              ...
              <div style={{fontSize:13,color:"var(--ink)",fontFamily:"'DM Sans',sans-serif",fontWeight:500,flex:1}}>{row.label}</div>
              <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:13,color:"var(--ink-light)",whiteSpace:"nowrap"}}>{row.done}/{row.total}</div>
            </div>
          ))}
        </div>
      </div>
  ...
  <div style={{background:"#fff",border:"1px solid var(--border)",borderRadius:14,boxShadow:"var(--shadow)",display:"flex",flexDirection:"column",height:380}}>
    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px 12px",flexShrink:0}}>
      <div style={{display:"flex",alignItems:"center",gap:8}}>
  ...
  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:16,alignItems:"stretch"}}>
    ...
    {(()=>{
      ...
      const R1=40,R2=30,R3=20,CX=50,CY=50;
              ...
              {[
                ...
                <div key={r.label}>
                  <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:4}}>
                    ...
                    <div style={{fontSize:12,fontFamily:"'DM Sans',sans-serif",color:"var(--ink)",flex:1,fontWeight:500}}>{r.label}</div>
                    <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:12,color:"var(--ink-light)"}}>{r.val!=null?`${r.val}/${r.goal} ${r.unit}`:"—"}</div>
                  </div>
                  <div style={{height:4,background:"var(--parchment)",borderRadius:2,overflow:"hidden"}}>
                    <div style={{height:"100%",width:`${r.val!=null?Math.min(100,Math.round(r.val/r.goal*100)):0}%`,background:r.dot,borderRadius:2,transition:"width .5s"}}/>
                  </div>
                </div>
              ))}
            </div>
    ...
    <div style={{background:"#fff",border:"1px solid var(--border)",borderRadius:14,padding:"18px 20px",boxShadow:"var(--shadow)",height:"100%",boxSizing:"border-box"}}>
      ...
      {monthGoalsArr.length===0?(
        <div style={{fontFamily:"'Cormorant Garamond',serif",fontStyle:"italic",fontSize:13,color:"var(--ink-light)"}}>No goals this month ✦</div>
      ):monthGoalsArr.slice(0,4).map(g=>{
        ...
        return(
          <div key={g.id} style={{marginBottom:14}}>
            <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:5}}>
              ...
              <div style={{flex:1,fontSize:12,fontFamily:"'DM Sans',sans-serif",fontWeight:500,color:"var(--ink)",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{g.title}</div>
              <span style={{fontFamily:"'Cormorant Garamond',serif",fontSize:12,color:"var(--ink-light)",flexShrink:0}}>{pct}%</span>
            </div>
            <div style={{height:4,background:"var(--parchment)",borderRadius:2,overflow:"hidden"}}>
              <div style={{height:"100%",width:`${pct}%`,background:"var(--sage)",borderRadius:2,transition:"width .5s"}}/>
            </div>
          </div>
        );
      })}
              ...
              <div style={{background:"#fff",border:"1px solid #EAE4DC",borderRadius:14,padding:"20px 24px",boxShadow:"var(--shadow)",marginBottom:14}}>
                ...
                <div style={{marginTop:14}}>
                  ...
                  <div style={{display:"flex",gap:8,alignItems:"center"}}>
                    ...
                    <input type="date" value={newProjTaskDue||TODAY} onChange={e=>setNewProjTaskDue(e.target.value)} onInput={e=>setNewProjTaskDue(e.target.value)} style={{border:"1px solid #EAE4DC",borderRadius:7,padding:"3px 8px",fontFamily:"'DM Sans',sans-serif",fontSize:11,color:"var(--ink)",background:"#faf7f3",outline:"none"}}/>
                  </div>
                </div>
              </div>
