...
import ptLogo from "./assets/The PT Transparent logo.png";
...
.sb-brand{padding:20px 16px 14px;margin-bottom:0;}
    ...
    <>
      ...
      <aside className="sidebar">
        <div className="sb-brand">
          <img src={ptLogo} alt="The PT" style={{width:"100%",maxWidth:160,display:"block",margin:"0 auto"}}/>
        </div>
